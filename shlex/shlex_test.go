...
func TestTokenizer(t *testing.T) {
	...
	expectedTokens := []*Token{
		{TokenType: WordToken, Value: "one "},
		{TokenType: WordToken, Value: "two "},
		{TokenType: WordToken, Value: "three four"},
		{TokenType: WordToken, Value: " five \"six\""},
		{TokenType: WordToken, Value: " seven#eight "},
		{TokenType: CommentToken, Value: " nine # ten\n"},
		{TokenType: WordToken, Value: " eleven "},
		{TokenType: WordToken, Value: "'twelve\\'"},
		{TokenType: WordToken, Value: " thirteen=13 "},
		{TokenType: WordToken, Value: "fourteen/14"},
	}
